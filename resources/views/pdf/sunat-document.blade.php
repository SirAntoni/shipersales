...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .qr-col .qr { width: 72px; height: 72px; }
    .qr-col .qr-cap { font-size: 7.5px; color: #3d079d; line-height: 1.25; margin-top: 4px; }
...
<div class="invoice">
                    ...
                    <table class="doc-info">
                        <tr>
                                ...
                                <table class="meta">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="meta-value">{{ $fechaTexto }}</div>
                                        </td>
                                    </tr>
                                </table>
                                <table class="meta">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="meta-value">{{ $currencyLabel }}</div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            <td class="qr-col">
                                ...
                                <div class="qr-cap">Verifica tu comprobante<br>en SUNAT</div>
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table class="client-grid">
                        <tr>
                            <td class="cg-left">
                                ...
                                <div class="field-label">{{ $client['docTypeLabel'] }}</div>
                                <div class="field-muted">{{ $client['docNumber'] }}</div>
                            </td>
                            <td class="cg-right">
                                <table class="addr">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="field-muted">{{ $client['address'] ?: '—' }}</div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
        ...
        <table class="items-tbl">
            <thead>
                <tr>
                    ...
                    <th>Descripción</th>
                    <th class="c3">Cant.</th>
                    <th class="c4">Valor unitario</th>
                    <th class="c5">Importe</th>
                </tr>
            </thead>
            <tbody>
                @foreach($items as $i => $item)
                    <tr>
                        ...
                        <td>
                            {{ $item['desc'] }}
                            @if(!empty($item['code']))
                                <div class="product-code">Código: {{ $item['code'] }}</div>
                            @endif
                        </td>
                        <td class="center">{{ number_format($item['qty'], 2) }}</td>
                        <td class="center">S/ {{ number_format($item['price'], 2) }}</td>
                        <td class="center">S/ {{ number_format($item['total'], 2) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <tr>
            <td class="left">
                ...
                <div class="card extra">
                    ...
                    <div class="info-row"><strong>Condición de pago:</strong>{{ $payCondition }}</div>
                    @if(!empty($affected))
                    <div class="info-row"><strong>Documento que modifica:</strong>{{ $affected }}</div>
                    @endif
                    @if(!empty($reason))
                    <div class="info-row"><strong>Motivo:</strong>{{ $reason }}</div>
                    @endif
                    <div class="info-row"><strong>Representación impresa de la</strong>{{ $repText }}</div>
                </div>
            </td>
                ...
                <div class="card totals">
                    <div class="totals-inner">
                        <table class="trow">
                            ...
                            <tr><td>I.G.V. (18%)</td><td class="amt">S/ {{ number_format($igv, 2) }}</td></tr>
                        </table>
                        <div class="tdivider"></div>
                        <table class="sprice">
                            <tr><td class="lbl">Importe total</td><td class="amt">S/ {{ number_format($total, 2) }}</td></tr>
                        </table>
                    </div>
                    <div class="pay-total">
                        <table class="pay">
                            <tr><td class="label">Total a pagar</td><td class="value">S/ {{ number_format($total, 2) }}</td></tr>
                        </table>
                    </div>
                </div>
            </td>
                ...
                <td class="secure-col">
                    <table class="secure">
                        <tr>
                            ...
                            <td>
                                <div class="secure-title">Comprobante válido</div>
                                <div class="secure-text">Emitido electrónicamente. Consulte la validez en SUNAT.</div>
                            </td>
                        </tr>
                    </table>
                </td>
    ...
    <div class="footbar">¡Gracias por su compra!<span class="orange"></span></div>
</div>
</body>
</html>
