                ...
                <div class="col-span-12 xl:col-span-12">
                    <div class="box box--stacked flex flex-col p-5 sm:p-14">
                                    ...
                                    @auth
                                        @if (auth()->id() === 1)
                                            <div
                                                ...
                                                <div class="space-y-2">
                                                    {{-- Estado finalizado / no finalizado --}}
                                                    <x-base.form-switch>
                                                        <x-base.form-switch.input
                                                            id="purchase-status-switch"
                                                            type="checkbox"
                                                            wire:model="status"
                                                            wire:change="updateStatus"
                                                        />
                                                        <x-base.form-switch.label for="purchase-status-switch">
                                                            Finalizado
                                                        </x-base.form-switch.label>
                                                    </x-base.form-switch>

                                                    {{-- NUEVO: Compra de cuadre --}}
                                            ...
                                            <div
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <x-base.form-switch>
                                                        <x-base.form-switch.input
                                                            id="purchase-square-switch"
                                                            type="checkbox"
                                                            wire:model.live="square"
                                                        />
                                                        <x-base.form-switch.label for="purchase-square-switch">
                                                            Cuadre
                                                        </x-base.form-switch.label>
                                                    </x-base.form-switch>
                        ...
                        <div class="-mx-8 border-t border-dashed border-slate-200/80 px-10 pt-6">
                            <div class="mt-5 text-slate-500">© {{ date('Y') }} Hecho con <i
