                                    ...
                                    <div class="inline-block mb-2 sm:mb-0 sm:mr-5 sm:text-right xl:mr-14 xl:w-60">
                                        <div class="text-left">
                                            ...
                                            <div class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                Si lo desactivas, pasará al módulo de Artículos.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex-1 w-full mt-3 xl:mt-0">
                                    ...
                                    <div class="space-y-4">
                                        @foreach ($rows as $i => $row)
                                            <div class="flex items-center space-x-2">
                                                <x-base.form-select class="w-30" wire:model.defer="rows.{{ $i }}.contact_id">
                                                ...
                                                />
                                                @if(count($rows) > 1)
                                                    <button wire:click.prevent="removeRow({{ $i }})" class="text-red-500 hover:text-red-700">
                                                        &times;
                                                    </button>
                                                @endif
                                            </div>
                                        ...
                                        <div class="flex space-x-2">
                                            <x-base.button wire:click.prevent="addRow" class="border-slate-300/80 bg-white/80" variant="outline-primary">
